...
export class VenueServiceController {
  static async createVenueService(req: Request, res: Response) {
    const { venueId, subCategoryId, bookingType, unitType, config } = req.body;

    const file = req.file;

    const data = await runService(() =>
      venueServiceService.create(
        {
          venueId,
          subCategoryId,
          bookingType,
  ...
  static async getRecommendedServices(req: Request, res: Response) {
    const data = await runService(() =>
      venueServiceService.getRecommendedServices(),
    );

    return sendSuccess(res, data, "Services retrieved successful");
  }
  ...
  static async getServiceByVenue(req: Request, res: Response) {
    ...
    const data = await runService(() =>
      venueServiceService.getByVenue(venueId),
    );
  ...
  static async getAllServiceByVenue(req: Request, res: Response) {
    ...
    const data = await runService(() =>
      venueServiceService.getAllServiceByVenue(venueId, query),
    );
  ...
  static async getSummary(req: Request, res: Response) {
    ...
    const data = await runService(() =>
      venueServiceService.getSummary(venueId),
    );
