...
export class VenueControllers {
  static async createVenue(req: Request, res: Response) {      const files = req.files as {
      ...
      const result = await runService(() => venueServices.createVenue(req.body, files));
  ...
  static async getVenues(req: Request, res: Response) {      const {
      ...
      const result = await runService(() => venueServices.getVenues({
  ...
  static async getPopularVenues(req: Request, res: Response) {      const {
      ...
      const result = await runService(() => venueServices.getPopularVenues({
        latitude: Number(latitude),
        longitude: Number(longitude),
        search: search as string,
        category: category as string,
  ...
  static async getCustomers(req: Request, res: Response) {      const venueId = req.params.venueId;
      ...
      const result = await runService(() => venueServices.getCustomers(
        venueId,
        search,
        segment,
      ));
  ...
  static async getVenueLikedByUser(req: Request, res: Response) {      const { userId } = req.params;
      ...
      const result = await runService(() => venueServices.getVenueLikedByUser(userId));
  ...
  static async getVenueDetail(req: Request, res: Response) {      const id = req.params.id;
      ...
      const result = await runService(() => venueServices.getVenueById(id, String(userId)));
  ...
  static async updateVenue(req: Request, res: Response) {      const id = req.params.id;
      ...
      const result = await runService(() => venueServices.updateVenue(id, data, files));
  ...
  static async toggleLike(req: Request, res: Response) {      const venueId = req.params.venueId;
      ...
      const result = await runService(() => venueServices.toggleLike(
        venueId,
        String(userId),
      ));
  ...
  static async getLikeCount(req: Request, res: Response) {      const venueId = req.params.venueId;
      const userId = req.user?.id;
      const result = await runService(() => venueServices.getLikeCount(
        venueId,
        String(userId),
      ));
  ...
  static async createImpression(req: Request, res: Response) {      const venueId = req.params.venueId;
      ...
      await runService(() => venueServices.createImpression({
        venueId,
        userId,
        ipAddress,
        userAgent,
  ...
  static async getImpressionCount(req: Request, res: Response) {      const venueId = req.params.venueId;
      ...
      const result = await runService(() => venueServices.getImpressionCount(venueId));
